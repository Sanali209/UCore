...
import logging
from ucore_framework.messaging.event_bus import EventBus, EventHandlerInfo
from ucore_framework.messaging.events import Event, ComponentStartedEvent, AppStartedEvent
...
class TestEventPublisherHelpers:
    ...
    def test_component_event_publishing(self, event_bus):
        ...
        from ucore_framework.messaging.events import UserEvent
